...
extension UIImage {
    ...
    func compressSize(with maxSize: Int) -> Data? {
        ...
        guard let compressImage = compressSize(defaultSize), let compressImageData = compressImage.jpegData(compressionQuality: 1.0) else {
            return nil
        }
        ...
        while finallImageData.count == 0 {
            ...
            guard let lastValue = compressionQualityArray.last,
                ...
                let tempCompressImage = tempImage.compressSize(defaultSize),
    ...
    func compressSize(_ newSize: CGSize) -> UIImage? {
        ...
        UIGraphicsBeginImageContext(finallSize)
