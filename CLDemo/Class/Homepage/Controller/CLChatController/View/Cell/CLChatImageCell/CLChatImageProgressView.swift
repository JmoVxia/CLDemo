...
extension CLChatImageProgressView {
    func seup(rect: CGRect) -> Void {
        ...
        shapeLayer.strokeColor = UIColor.hexColor(with: "#373747").cgColor
        ...
        gradientLayer.colors = NSArray.init(array: [UIColor.hexColor(with: "#5F98FC").cgColor, UIColor.hexColor(with: "#47BF00").cgColor]) as? [Any]
