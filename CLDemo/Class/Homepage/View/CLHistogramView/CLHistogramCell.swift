...
class CLHistogramCell: UITableViewCell {
    ...
    private lazy var morningLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.fillColor = UIColor.hexColor(with: "#ADE1D0").cgColor
        layer.contentsScale = UIScreen.main.scale
        return layer
    }()
    private lazy var noonLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.fillColor = UIColor.hexColor(with: "#79C9AE").cgColor
        layer.contentsScale = UIScreen.main.scale
        return layer
    }()
    private lazy var nightLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.fillColor = UIColor.hexColor(with: "#3B9778").cgColor
        layer.contentsScale = UIScreen.main.scale
        return layer
    }()
    private lazy var additionalLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.fillColor = UIColor.hexColor(with: "#20BC88").cgColor
        layer.contentsScale = UIScreen.main.scale
        return layer
    }()
    private lazy var exceedLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.fillColor = UIColor.hexColor(with: "#F57629").cgColor
        layer.contentsScale = UIScreen.main.scale
        return layer
    }()
    private lazy var seriousExceedLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.fillColor = UIColor.hexColor(with: "#BE0909").cgColor
        layer.contentsScale = UIScreen.main.scale
        return layer
    }()
