//
//  CLCustomTransitionViewController.m
//  CLDemo
//
...
#import "CLCustomTransitionAnimationViewController.h"

@interface CLCustomTransitionViewController ()

@property (nonatomic, strong) UIButton *button;

@end

@implementation CLCustomTransitionViewController
...
- (void)present {
    CLCustomTransitionAnimationViewController *controller = [[CLCustomTransitionAnimationViewController alloc] init];
