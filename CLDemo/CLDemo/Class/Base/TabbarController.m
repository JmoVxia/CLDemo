...
- (void)initUI
{
    ...
    UINavigationController *nc1 = [[UINavigationController alloc]initWithRootViewController:ec];
    ...
    UINavigationController *nc2 = [[UINavigationController alloc]initWithRootViewController:fc];
    ...
    UINavigationController *nc3 = [[UINavigationController alloc]initWithRootViewController:nc];
    ...
    UINavigationController *nc4 = [[UINavigationController alloc]initWithRootViewController:mc];
