...
class CLPopupFlopController: CLPopoverController {
    ...
    private lazy var topImageView: UIImageView = {
        ...
        topImageView.image = UIImage(named: "FlopTop")
    ...
    private lazy var closeButton: UIButton = {
        ...
        closeButton.setImage(UIImage(named: "FlopcloseButton"), for: .normal)
        closeButton.setImage(UIImage(named: "FlopcloseButton"), for: .selected)
        closeButton.setImage(UIImage(named: "FlopcloseButton"), for: .highlighted)
    ...
    private lazy var leftFlopButton: CLTwoSidedView = {
        ...
        leftFlopButton.topView = UIImageView(image: UIImage(named: "FlopCard"))
        leftFlopButton.bottomView = self.prizeView
        let tap = UITapGestureRecognizer(target: self, action: #selector(flopButtonAction(tap:)))
    ...
    private lazy var middleFlopButton: CLTwoSidedView = {
        ...
        middleFlopButton.topView = UIImageView(image: UIImage(named: "FlopCard"))
    ...
    private lazy var rightFlopButton: CLTwoSidedView = {
        ...
        rightFlopButton.topView = UIImageView(image: UIImage(named: "FlopCard"))
