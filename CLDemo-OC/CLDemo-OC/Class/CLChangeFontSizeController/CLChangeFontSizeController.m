...
#import "CLChangeFontSizeModel.h"
...
/**数据*/
@property (nonatomic, strong) NSMutableArray<CLChangeFontSizeModel *> *arrayDS;
/**slider*/
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CLChangeFontSizeModel *model = self.arrayDS[indexPath.row];
    cell.model = model;
    return cell;
}
...
- (NSMutableArray *) arrayDS{
    if (_arrayDS == nil){
        ...
        CLChangeFontSizeModel *model1 = [[CLChangeFontSizeModel alloc] initWithHeadImage:[UIImage imageNamed:@"111"] contentString:@"预览字体大小" fromMe:YES];
        [_arrayDS addObject:model1];
        
        CLChangeFontSizeModel *model2 = [[CLChangeFontSizeModel alloc] initWithHeadImage:[UIImage imageNamed:@"222"] contentString:@"拖拽或者点击下面的滑块，可设置字体大小" fromMe:NO];
        [_arrayDS addObject:model2];
        
        CLChangeFontSizeModel *model3 = [[CLChangeFontSizeModel alloc] initWithHeadImage:[UIImage imageNamed:@"222"] contentString:@"设置后，可改变聊天菜单中的字体大小。如果在使用过程中存在问题或意见，可反馈给我们团队" fromMe:NO];
...
- (CLChangeFontSizeSlider *) slider {
    if (_slider == nil){
        ...
        _slider.valueChangeBlock = ^(NSInteger Value) {
            ...
            [strongSelf.arrayDS enumerateObjectsUsingBlock:^(CLChangeFontSizeModel * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                [obj refreshFrame];
            }];
