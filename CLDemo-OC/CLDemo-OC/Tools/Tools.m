...
+ (void)setControllerTabBarItem:(UIViewController *)controller
    ...
    //未选中字体颜色  system为系统字体
    [controller.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:unselectColor,NSFontAttributeName:[UIFont fontWithName:foneName size:size * [CLChangeFontSizeHelper scaleCoefficient]]} forState:UIControlStateNormal];
    
    //选中字体颜色
    [controller.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:selectColor,NSFontAttributeName:[UIFont fontWithName:foneName size:size * [CLChangeFontSizeHelper scaleCoefficient]]} forState:UIControlStateSelected];
}
/**
 *  创建导航条上面的item按钮
 *
